    ...
    <div className="sm-scope fixed inset-0 z-50 pointer-events-none">
      ...
      >
        ...
        <header className="staggered-menu-header absolute top-0 left-0 w-full flex items-start justify-between px-[1em] lg:px-[3em] bg-transparent pointer-events-none z-20">
            ...
            <div className="relative bg-[#353639] h-[83px] w-[138px] md:h-[70px] md:w-[158px] lg:h-[120px] lg:w-[220px] flex items-center justify-center rounded-b-xl m-0 p-0 sm:-left-3 -top-4 md:-top-2">
              <Link href="/" className="block m-0 p-0">
                <Image
                  ...
                  alt="Logo"
                  className="h-[34px] md:h-[46px] lg:h-[62px] w-auto object-contain mt-3 md:mt-0 p-0"
                  draggable={false}
                  width={110}
                  height={24}
                  priority
          ...
          {/* Button Group */}
          <div className="relative flex bg-[#d8d8d8] px-[10px] py-2 lg:py-[10px] lg:px-4 shadow-xl rounded-full cursor-pointer gap-2 mt-4 pointer-events-auto md:-right-4">
            <Link href="/contact" aria-label="Go to contact">
              <div
                className="navbar-icon text-[24px] sm:text-[24px] lg:text-[30px] text-[#ff9b42] bg-[#353639] px-3 py-3 lg:px-4 lg:py-4 rounded-full"
