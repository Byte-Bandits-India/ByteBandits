  ...
  return (
    <section className="relative w-full h-[100dvh] flex flex-col justify-center items-center text-center overflow-hidden bg-white">
      ...
      <div className="relative z-10 w-full px-6 flex flex-col items-center justify-center mt-12">
        {/* Main Heading */}
        <h1
          className={`max-w-[880px] text-4xl sm:text-5xl md:text-6xl lg:text-[66px] font-bold md:semibold text-[#0f172a] mb-6 lg:mb-12 transition-all transform ${
        ...
        {/* Subtitle / Paragraph */}
        <p
          className={`hidden md:block max-w-[726px] text-base sm:text-lg md:text-[20px] lg:text-[24px] text-[#334155] leading-[27px] tracking-[-2%] mb-10 font-medium transition-all transform ${
            mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
          }`}
          style={{
            transitionDuration: "800ms",
        ...
        <p
          className={`md:hidden max-w-[726px] text-base sm:text-lg md:text-[20px] lg:text-[24px] text-[#334155] leading-[27px] tracking-[-2%] mb-10 font-medium transition-all transform ${
            mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
          }`}
          style={{
            transitionDuration: "800ms",
        ...
        >
          Ideas deserve more than development. They deserve strategy, speed, and a team 
          that treats every product like a business, not a backlog.
        </p>
        ...
        >
          <Link
            href="/contact"
            className="inline-flex items-center gap-2 bg-[#C62727] hover:bg-[#A31621] text-white px-6 md:px-8 py-3 rounded-xl text-sm md:text-base font-semibold shadow-[0_10px_25px_rgba(198,39,39,0.25)] hover:shadow-[0_15px_30px_rgba(163,22,33,0.35)] transition-all duration-300 transform hover:-translate-y-[2px]"
          >
            Book a Call
